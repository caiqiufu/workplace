...
import com.unieap.mdm.bo.SystemConfigBO;
...
public class MdmController extends BaseController {
	...
	public ModelAndView dic(HttpServletRequest request, HttpServletResponse response) throws Exception {
		ModelAndView ma = new ModelAndView("apps/base/mdm/dic/dic");
		/*
		 * Enumeration<String> names = request.getAttributeNames(); while
		 * (names.hasMoreElements()){ Object o= names.nextElement();
	...
	public @ResponseBody String getDicTreeData(TreeVO treeVO, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public @ResponseBody Map<String, String> dicDataDeal(String operType, DicDataTree dicDataTree,
	...
	public @ResponseBody String dicRoleGrid(PaginationSupport page, String dicCode, HttpServletRequest request,
	...
	public @ResponseBody String userGrid(PaginationSupport page, User vo, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public @ResponseBody Map<String, String> userDeal(String operType, User user, UserRole ur,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		UserBO userBO = (UserBO) ServiceUtils.getBean("userBO");
	...
	public @ResponseBody String userRoleGrid(PaginationSupport page, User user, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		UserBO userBO = (UserBO) ServiceUtils.getBean("userBO");
	...
	public @ResponseBody String chooseUserRoleGrid(PaginationSupport page, UserRoleVO vo, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public @ResponseBody Map<String, String> assignUserRole(String datas, User user, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		UserBO userBO = (UserBO) ServiceUtils.getBean("userBO");
	...
	public @ResponseBody String roleGrid(PaginationSupport page, Role vo, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public @ResponseBody Map<String, String> roleDeal(String operType, Role role, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		RoleBO bo = (RoleBO) ServiceUtils.getBean("roleBO");
	...
	public @ResponseBody String getRoleDicTreeData(TreeVO treeVO, int roleId, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		RoleBO bo = (RoleBO) ServiceUtils.getBean("roleBO");
	...
	public @ResponseBody Map<String, String> assignDicResource(String datas, Role role, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		RoleBO bo = (RoleBO) ServiceUtils.getBean("roleBO");
	...
	public @ResponseBody String getDicData(String isOptional, String parentCode, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public @ResponseBody String getCommDicList(Integer parentCode, String whereby, String isOptional,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		DicBO dicBO = (DicBO) ServiceUtils.getBean("dicBO");
	...
	public @ResponseBody Map<String, String> refreshDeal(String id, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "method=config")
	public ModelAndView config(HttpServletRequest request, HttpServletResponse response) throws Exception {
		ModelAndView ma = new ModelAndView("apps/base/mdm/systemconfig/systemconfig");
		return ma;
	}

	@RequestMapping(params = "method=configGrid")
	public @ResponseBody String configGrid(PaginationSupport page, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		SystemConfigBO systemConfigBO = (SystemConfigBO) ServiceUtils.getBean("systemConfigBO");
		systemConfigBO.getConfigList(page);
		return page.getJsonString();
	}

	@RequestMapping(params = "method=configDeal")
	public @ResponseBody Map<String, String> configDeal(String operType, SystemConfigVO vo, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		SystemConfigBO systemConfigBO = (SystemConfigBO) ServiceUtils.getBean("systemConfigBO");
		Map<String, String> model = systemConfigBO.configDeal(operType, vo);
		model.put(UnieapConstants.SUCCESS, UnieapConstants.SUCCESS);
		return model;
	}
}
