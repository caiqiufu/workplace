...
import com.apps.esb.service.bss.app.vo.queryaccumulation.AccumulationUsageVO;
import com.apps.esb.service.bss.app.vo.queryaccumulation.QueryAccumulationUsageVO;
...
public class QueryAccumulationUsage implements BizHandler {
	...
	public ProcessResult getResposeResult(SOAPMessage response) throws Exception {
		QueryAccumulationUsageVO queryAccumulationUsageVO = new QueryAccumulationUsageVO();
		List<AccumulationUsageVO> accmUsageList = new ArrayList<AccumulationUsageVO>();
		queryAccumulationUsageVO.setAccumulationUsageList(accmUsageList);
		ProcessResult result = new ProcessResult();
		result.setVo(queryAccumulationUsageVO);
		...
		if (document.getElementsByTagName("QueryAccumulationUsageResult").getLength() > 0) {
			...
			for (int i = 0; i < nodes.getLength(); i++) {
				...
				AccumulationUsageVO accmUsageVO = new AccumulationUsageVO();
