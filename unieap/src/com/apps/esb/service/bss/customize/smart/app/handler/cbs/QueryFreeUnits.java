...
import com.apps.esb.service.bss.app.vo.queryfreeunit.FreeUnitItemDetailVO;
import com.apps.esb.service.bss.app.vo.queryfreeunit.FreeUnitItemVO;
import com.apps.esb.service.bss.app.vo.queryfreeunit.QueryFreeUnitVO;
...
public class QueryFreeUnits implements BizHandler{
	...
	public ProcessResult getResposeResult(SOAPMessage response) throws Exception {
		...
		if (document.getElementsByTagName("bbs:FreeUnitItem").getLength() > 0){
			...
			queryFreeUnitVO.setFreeUnitItemList(freeUnitItemVOs);
