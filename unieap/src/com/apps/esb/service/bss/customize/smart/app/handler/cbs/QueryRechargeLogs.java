...
import com.apps.esb.service.bss.app.vo.querybalance.BalanceDetailVO;
import com.apps.esb.service.bss.app.vo.querybalance.CreditChgInfoVO;
import com.apps.esb.service.bss.app.vo.queryfreeunit.FreeUnitItemVO;
import com.apps.esb.service.bss.app.vo.querylifecycle.LifeCycleChgInfoVO;
import com.apps.esb.service.bss.app.vo.querylifecycle.LifeCycleStatusVO;
import com.apps.esb.service.bss.app.vo.queryrecharge.QueryRechargeLogVO;
import com.apps.esb.service.bss.app.vo.queryrecharge.RechargeBonusVO;
import com.apps.esb.service.bss.app.vo.queryrecharge.RechargeInfoVO;
import com.apps.esb.service.bss.customize.smart.app.vo.recharge.BalanceVO;
...
public class QueryRechargeLogs implements BizHandler {
			...
			for (int i = 0; i < rechargeInfoNodes.getLength(); i++) {
				...
				for (int j = 0; j < nodes.getLength(); j++) {
					...
					if ("ars:TradeTime".equals(node.getNodeName())) {
						...
						List<BalanceDetailVO> balanceVOs = new ArrayList<BalanceDetailVO>();
