...
@Service("newSubscriber_1")
public class SmartNewSubscriber extends CustSoapMessageHandler implements BizHandler {
	...
	public ProcessResult process(RequestInfo requestInfo, Map<String, String> handler,
		...
		newRequestInfo.getRequestHeader().setBizCode("newSubscriber");
