...
@Service("queryMyCdr")
public class QueryMyCdr implements BizHandler {
	...
	public ProcessResult process(RequestInfo requestInfo, Map<String, String> handler,
		...
		if (cdrInfoList != null && cdrInfoList.size() > 0) {
			...
			jsonResult.put("totalCDRNum", queryCdrVO.getTotalNum());
			jsonResult.put("beginRowNum", queryCdrVO.getBeginNum());
			jsonResult.put("fetchRowNum", queryCdrVO.getFetchNum());
