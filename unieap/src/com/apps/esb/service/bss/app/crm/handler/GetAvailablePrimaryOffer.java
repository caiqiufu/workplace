...
@Service("getAvailablePrimaryOffer")
public class GetAvailablePrimaryOffer extends SoapMessageHandler implements BizHandler {

	public GetAvailablePrimaryOffer() throws Exception {
		super();
	...
	public ProcessResult process(RequestInfo requestInfo, String parameters, Map<String, Object> extParameters)
		...
		newRequestInfo.getRequestHeader().setBizCode("getAvailablePrimaryOffer");
	...
	public ProcessResult getResposeResult(SOAPMessage response) throws Exception {
		AvailablePrimaryOfferingVO availablePrimaryOfferingVO = new AvailablePrimaryOfferingVO();
		ProcessResult result = new ProcessResult();
		result.setVo(availablePrimaryOfferingVO);
		...
		if (document.getElementsByTagName("quer:GetOfferingInfo").getLength() > 0) {
			...
			availablePrimaryOfferingVO.setOfferingInfoList(offeringInfoList);
			availablePrimaryOfferingVO.setOfferingInfoMap(offeringInfoMap);
