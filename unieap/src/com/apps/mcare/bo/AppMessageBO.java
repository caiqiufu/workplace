...
@Service("appMessageBO")
public class AppMessageBO extends BaseBO{
	public void getMessageGrid(PaginationSupport page, String type) throws Exception {
		DetachedCriteria criteria = DetachedCriteria.forClass(AppMessage.class);
		Property typeProperty = Property.forName("type");
		criteria.add(typeProperty.eq(type));
