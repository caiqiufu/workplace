...
public class ResourceConfigureBO extends BaseBO {
	...
	public Map<String, String> resourceConfigurePictureDeal(String parameters, List<FileItem> items) throws Exception {
		...
		String mcareAppPath = SYSConfig.getConfig().get("mcareAppPath");
		String url = SYSConfig.getConfig().get("url.images.res");
		String uploadPath = shareFolderPath+mcareAppPath+"/images/res";
