Ext.define('Utils',{
	getGridStyle:function(color1,color2,completePer){
		var dwidth = 50*completePer;
		return '<div style="background-color:'+color1+';"><div style="background-color:'+color2+';width:'+dwidth+';">' +'50%'+ '</div></div>';
	},
	/** 
	* 合并单元格 
