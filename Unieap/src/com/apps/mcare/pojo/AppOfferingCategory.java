...
public class AppOfferingCategory implements java.io.Serializable {
	...
	public AppOfferingCategory(int id, String categoryType, String categoreName, String activeFlag, Date createDate,
			String createBy) {
		this.id = id;
	...
	public AppOfferingCategory(int id, String categoryType, String categoreName, String seq, String categoryDesc,
