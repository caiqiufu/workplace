...
@Service("changeSupplementaryOffering")
public class ChangeSupplementaryOffering extends SoapMessageHandler implements BizHandler{

	public ChangeSupplementaryOffering() throws Exception {
		super();
	...
	public SOAPMessage getRequestSOAPMessage(String serviceNumber, RequestInfo requestInfo) throws Exception {
		...
		if (!offeringInfo.has("supplementaryOfferings")|| offeringInfo.getJSONArray("supplementaryOfferings").length()==0) {
