...
public class GetSubscriberData extends SoapMessageHandler implements BizHandler {

	public GetSubscriberData() throws Exception {
		super();
	...
	public ProcessResult process(RequestInfo requestInfo,String parameters,Map<String,Object> extParameters)
		...
		newRequestInfo.getRequestHeader().setBizCode("getSubscriberData");
