...
import com.unieap.www.esb.service.BssServiceLocator;

public class HelloWebServiceClient {

	// public static final String NAMESPACE_URI =
	// "http://www.ispring.com/ws/hello";
	...
	/*
	 * public static void test2(){ //BeanFactory f = new
	 * ClassPathXmlApplicationContext("spring-ws-servlet.xml"); //HelloService
	 * du = (HelloService)f.getBean("simpleService"); //du.sayHello("Chai");
	 * HelloServiceLocator locator = new HelloServiceLocator(); try { String
	 * repnose = locator.getHelloPort().sayHello("Chai Chai"); } catch
	 * (RemoteException | ServiceException e) { // TODO Auto-generated catch
	 * block e.printStackTrace(); } }
	 */
	public static void test3() {
		BssServiceLocator locator = new BssServiceLocator();
		try {
			String repnose = locator.getBssPort().queryInfo("testing json");
			System.out.println("response="+repnose);
