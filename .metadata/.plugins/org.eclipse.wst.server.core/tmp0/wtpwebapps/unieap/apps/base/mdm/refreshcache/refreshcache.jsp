    ...
    Ext.onReady(function(){
    	...
    	var grid = Ext.create('Ext.grid.Panel', {
    	        ...
    	        columns: [
    	            ...
    	            {text:'<%=UnieapConstants.getMessage("mdm.refreshcache.display.reloadSummary")%>', width:80,sortable:true, dataIndex: 'reloadSummary'},
    	            {text:'<%=UnieapConstants.getMessage("mdm.refreshcache.display.reloadDetails")%>',width:120,sortable : false, dataIndex: 'reloadDetails',
