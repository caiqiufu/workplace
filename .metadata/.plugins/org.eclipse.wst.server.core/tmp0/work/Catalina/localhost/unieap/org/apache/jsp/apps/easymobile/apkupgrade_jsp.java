 ...
 * Generated at: 2016-04-05 16:24:12 UTC
...
public final class apkupgrade_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if(error!=null){
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("<title>apk upgrade</title>\r\n");
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("    /***file uplaod begin*****************************************************/\r\n");
      out.write("    var allImgExt=\".apk|\"//å¨é¨å¾çæ ¼å¼ç±»å\r\n");
      out.write("    var allowExt=\".apk|\" //åè®¸ä¸ä¼ çæä»¶ç±»å Åä¸ºæ éå¶ æ¯ä¸ªæ©å±ååè¾¹è¦å ä¸ä¸ª\"|\" å°åå­æ¯è¡¨ç¤º\r\n");
      ...
      out.write("            fields:\r\n");
      out.write("            [\r\n");
      out.write("            \t'id','activeFlag','activeFlagDesc','version','changeDesc','createDate','effectiveDate','remark','fileId','tenantId'\r\n");
      out.write("            ],\r\n");
      ...
      out.write("            proxy:{ type: 'ajax', url: 'easyMobileController.do?method=apkUpgradeGrid',\r\n");
      out.write("                reader: \r\n");
      ...
      out.write("    \tif(UnieapButton.APK_Modify!=null&&UnieapButton.APK_Modify.abled==true){\r\n");
      ...
      out.print(UnieapConstants.getMessage("comm.title.list"));
      out.write("',\r\n");
      out.write("\t\t \t\tlisteners:{\r\n");
      out.write("\t\t \t\t   \t\tafterRender:function(thisForm, options){\r\n");
      out.write("\t\t\t        \tif(UnieapButton.APK_Add!=null&&UnieapButton.APK_Add.abled== true){\r\n");
      out.write("\t\t\t        \t\tExt.getCmp('APK_Add').show();\r\n");
      out.write("\t\t\t        \t}\r\n");
      out.write("\t\t            }\r\n");
      out.write("\t\t        },\r\n");
      ...
      out.write("\t\t   \t   \t\t{ text: \"");
      out.print(UnieapConstants.getMessage("mcare.apkupgrade.display.version"));
      out.write("\", dataIndex: 'version',sortable: false,width:100},\r\n");
      out.write("       \t   \t\t\t{ text: \"");
      out.print(UnieapConstants.getMessage("mcare.apkupgrade.display.changeDesc"));
      out.write("\", dataIndex: 'changeDesc',flex: true, sortable: false,width:500,\r\n");
      ...
      out.write("\",width: 150, dataIndex: 'effectiveDate',sortable: false},\r\n");
      out.write("       \t   \t\t\t{ text: \"");
      ...
      out.write("',text:'");
      out.print(UnieapConstants.getMessage("comm.add"));
      out.write("',xtype:'button',id:'APK_Add',hidden:true,\r\n");
      ...
      out.write("\t                        \t{ xtype:'textfield',hidden: true, name:'fileId'},\r\n");
      out.write("\t                        \t{ xtype:'textfield',hidden: true, name:'tenantId'},\r\n");
      out.write("\t                        \t{ xtype:'textfield',labelWidth:80, width:350, name:'version',fieldLabel:'<font color=red>*</font>");
      out.print(UnieapConstants.getMessage("mcare.apkupgrade.display.version"));
      out.write("',maxLength:45,allowBlank:false},\r\n");
      out.write("\t                        \t{ xtype:'textareafield',labelWidth:80, width:350, name:'changeDesc',fieldLabel:'<font color=red>*</font>");
      out.print(UnieapConstants.getMessage("mcare.apkupgrade.display.changeDesc"));
      out.write("',height:150,\r\n");
      out.write("\t                        \t\tmaxLength:512,growMin:60,growMax:100,allowBlank:false},\r\n");
      ...
      out.write("\t\t                   \t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t{ xtype:'filefield',name: 'file',id:'uploadFileFormApk',labelWidth:80,width:420,fieldLabel:'");
      out.print(UnieapConstants.getMessage("mcare.apkupgrade.display.apkfile"));
      ...
      out.write("                { title: '");
      out.print(UnieapConstants.getMessage("comm.data"));
      out.write("', closeAction: 'hide', width: 400, height: 450, layout: 'fit', modal: true, items: dataForm,defaultFocus: 'version' });\r\n");
      out.write("            }\r\n");
      out.write("            if(operType=='Add'){\r\n");
      out.write("            \tdataForm.getForm().reset();\r\n");
      out.write("            \tdataWin.show();\r\n");
      out.write("            \tdataForm.getForm().findField('file').show();\r\n");
      out.write("            }else if(operType=='Modify'){\r\n");
      out.write("            \tdataWin.show();\r\n");
      out.write("            \tdataForm.getForm().setValues(selectedRecord.data);\r\n");
      out.write("            \tdataForm.getForm().findField('effectiveDate').setValue(Ext.util.Format.date(selectedRecord.data.effectiveDate,\"Y-m-d h:i:s\"));\r\n");
      out.write("            \tdataForm.getForm().findField('file').hide();\r\n");
      out.write("            }else{\r\n");
      out.write("            \tdataWin.show();\r\n");
      out.write("            }\r\n");
      out.write("\t   }\r\n");
      ...
      out.write("            \tvar fileOriginalName = form.findField('uploadFileFormApk').getValue();\r\n");
      out.write("            \tif(operType=='Add'){\r\n");
      ...
      out.write("',\r\n");
      out.write("                \t\t\tmsg:'");
      out.print(UnieapConstants.getMessage("comm.fileupload.filetype",".apk"));
      out.write("',\r\n");
      ...
      out.write("        \t}\r\n");
      out.write("       }    \r\n");
      out.write("       function submitApk(form){\r\n");
      out.write("    \t\tvar id = form.findField('id').getValue();\r\n");
      out.write("        \tvar version = form.findField('version').getValue();\r\n");
      out.write("        \tvar changeDesc = form.findField('changeDesc').getValue();\r\n");
      out.write("        \tvar activeFlag = form.findField('activeFlag').getValue();\r\n");
      out.write("        \tvar effectiveDate = dateTimeFormat(form.findField('effectiveDate').getValue());\r\n");
      out.write("        \tvar remark = form.findField('remark').getValue();\r\n");
      out.write("        \tvar parameters = Ext.JSON.encode({'id':id,'version':version,'changeDesc':changeDesc,'activeFlag':activeFlag,'effectiveDate':effectiveDate,'remark':remark})\r\n");
      ...
      out.write("',\r\n");
      out.write("                    url: 'easyMobileController.do?method=apkUpgradeDeal&operType='+operType+'&parameters='+parameters,\r\n");
