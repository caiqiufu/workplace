 ...
 * Generated at: 2016-04-07 18:06:51 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.apps.base.mdm.dic;
...
public final class dic_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if(error!=null){
      ...
      out.write("                url: 'mdmController.do?method=getDicTreeData'\r\n");
      out.write("            },\r\n");
      ...
      out.write("\t        listeners:{\r\n");
      out.write("\t        \titemcontextmenu: function(view, record, node, index, e){\r\n");
      out.write("\t        \t\tselectedNode = record;\r\n");
      out.write("\t        \t\tvar addDisabled = false;\r\n");
      out.write("\t        \t\tif(UnieapButton.Dic_Add==null){\r\n");
      out.write("\t        \t\t\taddDisabled = true;\r\n");
      out.write("\t        \t\t}\r\n");
      out.write("\t        \t\tvar modifyDisabled = false;\r\n");
      out.write("\t        \t\tif(UnieapButton.Dic_Modify==null){\r\n");
      out.write("\t        \t\t\tmodifyDisabled = true;\r\n");
      out.write("\t        \t\t}\r\n");
      out.write("\t        \t\tvar rightMenu = new Ext.menu.Menu({\r\n");
      out.write("\t                    items: [{\r\n");
      out.write("\t                    \ticonCls : 'add',\r\n");
      out.write("\t                    \tdisabled : addDisabled,\r\n");
      out.write("\t                        text: '");
      out.print(UnieapConstants.getMessage("comm.add"));
      out.write("',\r\n");
      out.write("\t                        handler: Ext.bind(function(btn){\r\n");
      out.write("\t                        \trightMenu.hide();\r\n");
      out.write("\t                        \taddNode();\r\n");
      out.write("\t                        },this)\r\n");
      out.write("\t                    }, {\r\n");
      out.write("\t                    \ticonCls : 'edit',\r\n");
      out.write("\t                    \tdisabled : modifyDisabled,\r\n");
      out.write("\t                        text: '");
      out.print(UnieapConstants.getMessage("comm.modify"));
      out.write("',\r\n");
      out.write("\t                        handler: Ext.bind(function(){\r\n");
      out.write("\t                        \trightMenu.hide();\r\n");
      out.write("\t                        \tif(selectedNode.data.id==1){\r\n");
      out.write("\t                        \t\tExt.MessageBox.show({title: '");
      out.print(UnieapConstants.getMessage("comm.status"));
      out.write("',msg:'");
      out.print(UnieapConstants.getMessage("mdm.dic.check.root.noModify"));
      out.write("',\r\n");
      ...
      out.write("\t        \t\trightMenu.showAt(e.getXY());\r\n");
      out.write("\t                return false;\r\n");
      out.write("\t        \t},\r\n");
      out.write("\t        \titemclick:function(view, record, node, index, e, eOpts){\r\n");
      out.write("\t        \t\troleGridStore.load({params:{dicCode:record.data.extendAttri.dicCode}});\r\n");
      out.write("\t        \t}\r\n");
      out.write("\t        }\r\n");
      out.write("\t   \t})\r\n");
      out.write("\t   \t\r\n");
      ...
      out.write("            proxy:{ type: 'ajax', url: 'mdmController.do?method=dicRoleGrid',\r\n");
      out.write("                reader: \r\n");
      ...
      out.write("\t   \t        Ext.apply(store.proxy.extraParams,{dicCode:'-1'});\r\n");
      out.write("\t   \t     });\r\n");
      out.write("    \tvar selModel = Ext.create('Ext.selection.CheckboxModel',{mode:'single'});\r\n");
      out.write("    \tvar roleDatagrid = Ext.create('Ext.grid.Panel', \r\n");
      out.write("    \t        {region: 'east',width: 500,columnLines: true,autoScroll:true,autoExpandColumn:'action',\r\n");
      ...
      out.write("                        items:\r\n");
      out.write("                        [\r\n");
      out.write("                        \t{ xtype:'textfield',hidden: true, name:'dicId'},\r\n");
      out.write("                        \t{ xtype:'textfield',hidden: true, name:'parentId'},\r\n");
      out.write("                        \t{ xtype:'textfield',hidden: true, name:'parentCode'},\r\n");
      out.write("                        \t{ xtype:'textfield',hidden: true, name:'parentName'},\r\n");
      out.write("                        \t{ xtype:'textfield',hidden: true, name:'dicType'},\r\n");
      ...
      out.write("                        \t{ xtype:'textfield',labelWidth:80, width:350, name:'dicCode',fieldLabel:'<font color=red>*</font>");
      out.print(UnieapConstants.getMessage("mdm.dic.display.dicCode"));
      out.write("',maxLength:45,allowBlank:false},\r\n");
      out.write("                        \t{ xtype:'textfield',labelWidth:80, width:350, name:'dicName',fieldLabel:'<font color=red>*</font>");
      out.print(UnieapConstants.getMessage("mdm.dic.display.dicName"));
      out.write("',maxLength:128,allowBlank:false},\r\n");
      out.write("                        \t{ xtype:'numberfield', labelWidth:80, width:350,name:'seq',fieldLabel:'");
      out.print(UnieapConstants.getMessage("mdm.dic.display.sequence"));
      out.write("',minValue: 0,maxValue:1000,allowBlank:true},\r\n");
      out.write("                        \t{ xtype:'textfield', labelWidth:80, width:350,name:'href',fieldLabel:'");
      out.print(UnieapConstants.getMessage("mdm.dic.display.href"));
      out.write("'},\r\n");
      ...
      out.print(UnieapConstants.getMessage("comm.remark"));
      out.write("',growMin:60,growMax:100,maxLength:255,allowBlank:true}\r\n");
      out.write("                        ]\r\n");
      out.write("                    }\r\n");
      out.write("                   ],\r\n");
      out.write("                   buttons: \r\n");
      ...
      out.write("',\r\n");
      out.write("                        handler: function() {\r\n");
      out.write("                            if(dataForm.getForm().isDirty){\r\n");
      ...
      out.print(UnieapConstants.getMessage("comm.title.confirm"));
      out.write("', '");
      out.print(UnieapConstants.getMessage("common.form.noupdate"));
      out.write("');\r\n");
      out.write("                            }\r\n");
      out.write("                        }\r\n");
      out.write("                    }\r\n");
      ...
      out.write("               { title: '");
      out.print(UnieapConstants.getMessage("comm.data"));
      out.write("', closeAction: 'hide', width: 400, height: 300, layout: 'fit', modal: true, items: dataForm,defaultFocus: 'dicName' });\r\n");
      out.write("           }\r\n");
      out.write("           if(operType=='Add'){\r\n");
      out.write("\t           \tdataForm.getForm().reset();\r\n");
      out.write("\t           \tdataWin.show();\r\n");
      out.write("\t           \tif(selectedNode.data.id==1){\r\n");
      out.write("\t           \t\tdataForm.getForm().setValues({parentId:1});\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({parentCode:'root'});\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({parentName:'Root'});\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({dicType:'D'});\r\n");
      out.write("\t           \t}else{\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({parentId:selectedNode.data.extendAttri.dicId});\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({parentCode:selectedNode.data.extendAttri.dicCode});\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({parentName:selectedNode.data.extendAttri.dicName});\r\n");
      out.write("\t\t           \tdataForm.getForm().setValues({dicType:selectedNode.data.extendAttri.dicType});\r\n");
      out.write("\t           \t}\r\n");
      out.write("\t           \tdataForm.getForm().findField('dicCode').setReadOnly(false);\r\n");
      out.write("\t           \tdataForm.getForm().findField('dicCode').inputEl.removeCls('readonly_field');\r\n");
      out.write("           \t\tdataForm.getForm().findField('dicName').setReadOnly(false);\r\n");
      out.write("           \t\tdataForm.getForm().findField('dicName').inputEl.removeCls('readonly_field');\r\n");
      out.write("           \t\tdataForm.getForm().findField('seq').setReadOnly(false);\r\n");
      out.write("           \t\tdataForm.getForm().findField('seq').inputEl.removeCls('readonly_field');\r\n");
      out.write("           \t\tdataForm.getForm().findField('href').setReadOnly(false);\r\n");
      out.write("           \t\tdataForm.getForm().findField('href').inputEl.removeCls('readonly_field');\r\n");
      ...
      out.write("           \t\tdataForm.getForm().findField('remark').setReadOnly(false);\r\n");
      out.write("           \t\tdataForm.getForm().findField('remark').inputEl.removeCls('readonly_field');\r\n");
      out.write("           }else if(operType=='Modify'){\r\n");
      out.write("        \t    dataForm.getForm().reset();\r\n");
      out.write("\t           \tdataWin.show();\r\n");
      out.write("\t           \tif(selectedNode.data.extendAttri.createBy=='unieap'){\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('dicCode').setReadOnly(true);\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('dicCode').inputEl.addCls('readonly_field');\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('dicName').setReadOnly(true);\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('dicName').inputEl.addCls('readonly_field');\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('seq').setReadOnly(true);\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('seq').inputEl.addCls('readonly_field');\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('href').setReadOnly(true);\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('href').inputEl.addCls('readonly_field');\r\n");
      ...
      out.write("\t           \t\tdataForm.getForm().findField('remark').setReadOnly(true);\r\n");
      out.write("\t           \t\tdataForm.getForm().findField('remark').inputEl.addCls('readonly_field');\r\n");
      out.write("\t           \t}\r\n");
      out.write("\t           \tdataForm.getForm().setValues(selectedNode.data.extendAttri);\r\n");
      out.write("           }else{\r\n");
      out.write("           \t\tdataWin.show();\r\n");
      out.write("           }\r\n");
      out.write("   \t  }\r\n");
      ...
      out.write("\t                  url: 'mdmController.do?method=dicDataDeal',\r\n");
      ...
      out.write("\t                      \t\t\tbuttons: Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});\r\n");
      out.write("\t\t\t                    }else{\r\n");
      out.write("\t\t\t                    \tvar dicId = form.findField('dicId').getValue();\r\n");
      out.write("\t\t\t                    \tif(operType=='Add'){\r\n");
      out.write("\t\t\t                    \t\tdicId = result.id;\r\n");
      out.write("\t\t\t                    \t}\r\n");
      out.write("\t\t\t                    \tvar dicCode = form.findField('dicCode').getValue();\r\n");
      out.write("\t\t\t                    \tvar dicName = form.findField('dicName').getValue();\r\n");
      out.write("\t\t\t                    \tvar parentId = form.findField('parentId').getValue();\r\n");
      out.write("\t\t\t                    \tvar parentCode = form.findField('parentCode').getValue();\r\n");
      out.write("\t\t\t                    \tvar parentName = form.findField('parentName').getValue();\r\n");
      out.write("\t\t\t                    \tvar dicType = form.findField('dicType').getValue();\r\n");
      out.write("\t\t\t                    \tvar text = '['+dicCode+']'+dicName;\r\n");
      out.write("\t\t\t                    \tvar seq = form.findField('seq').getValue();\r\n");
      out.write("\t\t\t                    \tvar href = form.findField('href').getValue();\r\n");
      out.write("\t\t\t                    \tvar activeFlag = form.findField('activeFlag').getValue();\r\n");
      out.write("\t\t\t                    \tvar remark = form.findField('remark').getValue();\r\n");
      out.write("\t\t\t                    \tvar extendAttri = {dicId:dicId,dicCode:dicCode,dicName:dicName,parentId:parentId,\r\n");
      out.write("\t\t\t                    \t\t\tparentCode:parentCode,parentName:parentName,dicType:dicType,\r\n");
      out.write("\t\t\t                    \t\t\tseq:seq,href:href,activeFlag:activeFlag,remark:remark};\r\n");
      out.write("\t\t\t                    \tif(operType=='Add'){\r\n");
      out.write("\t\t\t                    \t\tdicId = result.id;\r\n");
      out.write("\t\t\t\t                    \tcreateNode({id:dicId,text:text,draggable: false,leaf: true},extendAttri);\r\n");
      out.write("\t\t\t                    \t}else if(operType=='Modify'){\r\n");
      out.write("\t\t\t                    \t\tselectedNode.set('text',text);\r\n");
      out.write("\t\t\t                    \t\tselectedNode.data.extendAttri = extendAttri;\r\n");
      out.write("\t\t\t                    \t}\r\n");
      out.write("\t\t\t                    \tExt.MessageBox.show({title: '");
      out.print(UnieapConstants.getMessage("comm.status"));
      out.write("',msg:'");
      ...
      out.write("      \t\tdataWin.hide();\r\n");
      out.write("\t  }\r\n");
      out.write("      function createNode(config,extendAttri) {\r\n");
      out.write("          var child = selectedNode.appendChild(config);\r\n");
      out.write("          child.data.extendAttri = extendAttri;\r\n");
      out.write("          selectedNode.set('leaf',false);  \r\n");
      out.write("          selectedNode.expand();\r\n");
      out.write("      }\t   \r\n");
      out.write("\t   \t\r\n");
      out.write("\t});\r\n");
      out.write("    </script>\r\n");
